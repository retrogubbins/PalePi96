...
{
      sprintf(romset_files[0*8+0],"ROMS/lynx48-1.rom");
      sprintf(romset_files[0*8+1],"ROMS/lynx48-2.rom");
      romset_hwtypes[0]=LYNX_HARDWARE_48;
      sprintf(romset_files[1*8+0],"ROMS/lynx96-1.rom");
      sprintf(romset_files[1*8+1],"ROMS/lynx96-2.rom");
      sprintf(romset_files[1*8+2],"ROMS/lynx96-3.rom");
      romset_hwtypes[1]=LYNX_HARDWARE_96;
      sprintf(romset_files[2*8+0],"ROMS/lynx128-1.rom");
      sprintf(romset_files[2*8+1],"ROMS/lynx128-2.rom");
      sprintf(romset_files[2*8+2],"ROMS/lynx128-3.rom");
      romset_hwtypes[2]=LYNX_HARDWARE_128;
      sprintf(romset_files[3*8+0],"ROMS/lynx96-1.rom");
      sprintf(romset_files[3*8+1],"ROMS/lynx96-2.rom");
      sprintf(romset_files[3*8+2],"ROMS/lynx96-3.rom");
      sprintf(romset_files[3*8+7],"ROMS/dosrom.rom");
      romset_hwtypes[3]=LYNX_HARDWARE_96;
      sprintf(romset_files[4*8+0],"ROMS/lynx128-1.rom");
      sprintf(romset_files[4*8+1],"ROMS/lynx128-2.rom");
      sprintf(romset_files[4*8+2],"ROMS/lynx128-3.rom");
      sprintf(romset_files[4*8+7],"ROMS/dosrom.rom");
